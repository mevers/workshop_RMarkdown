...
```{r out.width="450px", fig.pos="H"}
# Show external image
knitr::include_graphics("figures/imperialseal.jpg")
```
...
pander::pandoc.table(starwars[1:10, 1:6]);
```
...
print(xtable(starwars[1:10, 1:6]), comment=FALSE);
```
