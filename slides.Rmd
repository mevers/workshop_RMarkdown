...
1. base R
2. [`ggplot2`](http://ggplot2.org/) from the [`tidyverse`](http://www.tidyverse.org/)
<p style="margin-top:2em">
3. [`plotly`](https://plot.ly/r/)
4. [`dygraph`](https://rstudio.github.io/dygraphs/r-markdown.html) 
5. D3 in R
