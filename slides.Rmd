...
1. Experiment with different markdown elements in your RMarkdown document
    + Introduce headers
    + Emphasise words by making them italic
...
2. **Whitespace is important**: 
    ...
    + A list requires a preceding newline (this is not the case in e.g. GitHub-flavoured markdown)
...
2. Change the date to automatically give the current "DayOfTheWeek, Day MonthName YearWithCentury".
2. Add a subtitle to your document.
2. Add a second authors.
