...
<ol start="0">
<li> If you need help with cloning the GitHub repo, setting up RStudio, and/or installing necessary R packages, now is the time to let us know...
<p style="margin-top:2em">
...
<li> Add some text to your RMarkdown file. You can either use your own text, or download a text file and copy & paste its content into your RMarkdown document.
```
# R code
download.file(
