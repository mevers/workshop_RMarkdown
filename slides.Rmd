...
<div class="boxed">6 interactive sessions.</div>

# Preface - prepare your data!

## Prepare your data

In particular for interactive, "living" documents, it makes sense to separate data preparation and analysis/presentation.

1. pre-process your raw data
2. includes data cleaning, sanity checks, etc.
3. deal with data inconsistencies
4. results in clean data which can then be distributed with your documents (e.g. as appendix) and forms basis for iterations of subsequent analyses
...
<ol start="0">
<li> If you need help with setting up RStudio and R packages, now is the time to let us know...
<p style="margin-top:2em">
<li> Create a new R Markdown (Rmd) document in RStudio.
<li> Select PDF, Word, or HTML as output option.
...
<p style="margin-top:2em">**Example 3:** Bookdown
